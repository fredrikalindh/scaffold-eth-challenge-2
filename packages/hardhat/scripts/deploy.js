...
const main = async () => {
  ...
  // const result = await yourToken.transfer( "0xf5D67f65B982B6bfC0d66E28652968463C2201F6", utils.parseEther("1000") );
  ...
  await vendor.transferOwnership( "0xf5D67f65B982B6bfC0d66E28652968463C2201F6" );
